/*
** graphic_color.c for battletrantor in /home/rannou_s/Work/graoom/client/graphic
** 
** Made by sebastien rannou
** Login   <rannou_s@epitech.net>
** 
** Started on  Sun Jul 26 14:40:55 2009 sebastien rannou
** Last update Thu Oct  1 17:38:59 2009 sebastien rannou
*/
...
graphic_load_colors_create(ini_section_t *section)
{
  ...
  LOG(GRAPHIC_LOADING_COLOR_OK, new_color->name);
  return (SUCCESS);
}
